...
<body>
    <section class="vh-100" style="background-color: #2b2b2b;">
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="{{ route('register') }}" method="POST">
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <input type="text" id="form2Example1" name="name" class="form-control form-control-lg" required />
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">¿Ya tienes una cuenta? <a href="{{ route('login') }}" style="color: #393f81;">Iniciar sesión aquí</a></p>
